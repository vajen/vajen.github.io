...
var operators_1 = __webpack_require__(99);
var el = document.querySelector('.live-search');
var ul = document.querySelector('.search-results');
var text$ = rxjs_1.fromEvent(el, 'input');
var results$ = text$.pipe(operators_1.debounceTime(500), operators_1.map(function (ev) {
    return ev.target.value;
}), operators_1.filter(function (value) { return value !== ''; }), operators_1.distinctUntilChanged(), operators_1.switchMap(function (value) {
    return (fetch("https://api.github.com/search/repositories?q=" + value)
        .then(function (response) { return response.json(); }));
}), operators_1.map(function (values) {
    return values.items;
